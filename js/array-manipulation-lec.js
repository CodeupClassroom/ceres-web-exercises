...
(function () {
    ...
    var csvNames = 'David,Vivian,Justin,Cody The Duck';
    ...
    var alphaTeam = ["David", "Sophie", "Daniel", "Maggie", "Cody The Duck", "Ryan"];
    var goldTeam = ["Fer", "Justin", "Zach", "David from Data Science", "Akuma from Street Fighter", "Jason"];
